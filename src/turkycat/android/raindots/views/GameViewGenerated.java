...
import turkycat.android.raindots.R.styleable;
 ...
 */
public class GameViewGenerated extends View {
	...
	public GameViewGenerated(Context context) {
		super(context);
		init(null, 0);
	}

	public GameViewGenerated(Context context, AttributeSet attrs) {
		super(context, attrs);
		init(attrs, 0);
	}

	public GameViewGenerated(Context context, AttributeSet attrs, int defStyle) {
	...
	private void init(AttributeSet attrs, int defStyle) {
		...
		final TypedArray a = getContext().obtainStyledAttributes(attrs,
				R.styleable.GameView, defStyle, 0);

		mExampleString = a.getString(R.styleable.GameView_exampleString);
		mExampleColor = a.getColor(R.styleable.GameView_exampleColor,
				mExampleColor);
		// Use getDimensionPixelSize or getDimensionPixelOffset when dealing
		// with
		// values that should fall on pixel boundaries.
		mExampleDimension = a.getDimension(
				R.styleable.GameView_exampleDimension, mExampleDimension);

		if (a.hasValue(R.styleable.GameView_exampleDrawable)) {
			mExampleDrawable = a
					.getDrawable(R.styleable.GameView_exampleDrawable);
